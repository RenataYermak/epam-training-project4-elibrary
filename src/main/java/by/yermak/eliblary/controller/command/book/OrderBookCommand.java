...
public class OrderBookCommand implements Command {
    ...
    public OrderBookCommand() {
        this.bookOrderService = new BookOrderServiceImpl();
    ...
    public Router execute(HttpServletRequest request, HttpSession session) {
        ...
        if (isAdmin(session)) {
            try {
                ...
                String issue = request.getParameter(RequestParameter.ISSUE);
                Long orderId = bookOrderService.orderBook(bookId, userId, Issue.valueOf(issue.toUpperCase()));
