...
//
//import by.yermak.eliblary.dao.BookDao;
//import by.yermak.eliblary.dao.EntityDao;
//import by.yermak.eliblary.dao.mapper.impl.BookMapper;
...
//import java.util.Optional;
//
//public class BookDaoImpl extends EntityDao<Book> implements BookDao {
//    private static final Logger LOGGER = LogManager.getLogger();
//    private final BookMapper bookMapper = new BookMapper();
//
//    private static class Query {
...
//        LOGGER.log(Level.INFO, "method create");
//        try (Connection connection  = ConnectionPool.getInstance().getConnection();
//                PreparedStatement preparedStatement = connection.prepareStatement(Query.INSERT_BOOK)) {
//            constructPrepareStatement(preparedStatement, book);
//            preparedStatement.executeUpdate();
//            try (ResultSet resultSet = preparedStatement.getGeneratedKeys()) {
//                if (resultSet.next()) {
